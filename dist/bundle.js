...
exports.FilterItem = exports.normalize = exports.fetch = undefined;
...
var _normalizer = __webpack_require__(24);

Object.defineProperty(exports, 'normalize', {
    enumerable: true,
    get: function get() {
        return _interopRequireDefault(_normalizer).default;
    }
});
...
var _filterItem = __webpack_require__(29);
...
var _richListPage = __webpack_require__(19);

var _richListPage2 = _interopRequireDefault(_richListPage);
...
var App = function (_Component) {
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(_richListPage2.default, null);
        }
    }]);
...
*/
var aa=__webpack_require__(0);__webpack_require__(5);var l=__webpack_require__(10),n=__webpack_require__(3),ba=__webpack_require__(11),ca=__webpack_require__(1),da=__webpack_require__(4),ea=__webpack_require__(12),fa=__webpack_require__(13),ha=__webpack_require__(16),ia=__webpack_require__(17);
...
var _richListTitle = __webpack_require__(20);

var _richListTitle2 = _interopRequireDefault(_richListTitle);

var _richListFilters = __webpack_require__(21);

var _richListFilters2 = _interopRequireDefault(_richListFilters);

var _richList = __webpack_require__(30);

var _richList2 = _interopRequireDefault(_richList);
...
var RichListPage = function (_Component) {
    _inherits(RichListPage, _Component);

    function RichListPage() {
        _classCallCheck(this, RichListPage);

        var _this = _possibleConstructorReturn(this, (RichListPage.__proto__ || Object.getPrototypeOf(RichListPage)).call(this));

        _this.onFilterChanged = function (filterData) {
            var name = filterData.name,
                value = filterData.value;
            var selectedFilters = _this.state.selectedFilters;

            var newFilters = _extends({}, selectedFilters);
        ...
        _this.applyFilters = function () {
            var _this$state = _this.state,
                richList = _this$state.richList,
                _this$state$selectedF = _this$state.selectedFilters,
                selectedCountry = _this$state$selectedF.selectedCountry,
                selectedCurrency = _this$state$selectedF.selectedCurrency,
                searchText = _this$state$selectedF.searchText,
                selectedOrderBy = _this$state$selectedF.selectedOrderBy;

            var _selectedCurrency$spl = selectedCurrency.split('-'),
                _selectedCurrency$spl2 = _slicedToArray(_selectedCurrency$spl, 2),
                code = _selectedCurrency$spl2[0],
                conversionRate = _selectedCurrency$spl2[1]; //usd-1, euro-0.92, aud-0.78


            var filteredResult = richList.map(function (r) {
                return _extends({}, r, {
    ...
    _createClass(RichListPage, [{
        ...
        value: function componentDidMount() {
            ...
            (0, _common.fetch)('/richList').then(function (res) {
                var _normalize = (0, _common.normalize)(res),
                    titleData = _normalize.titleData,
                    filterOptionsData = _normalize.filterOptionsData,
                    richList = _normalize.richList;
        ...
        value: function render() {
            var _state = this.state,
                titleData = _state.titleData,
                filterOptionsData = _state.filterOptionsData,
                selectedFilters = _state.selectedFilters,
                richList = _state.richList;

            var selectedCurrencyCode = selectedFilters.selectedCurrency.split('-')[0];

            var filteredResult = this.applyFilters(richList);
            return _react2.default.createElement(
                'div',
                { className: 'main' },
                _react2.default.createElement(_richListTitle2.default, { titleData: titleData }),
                _react2.default.createElement(
                    'div',
                    { className: 'content' },
                    _react2.default.createElement(_richListFilters2.default, { filterOptionsData: filterOptionsData,
                        selectedFilters: selectedFilters,
                        onFilterChanged: this.onFilterChanged }),
                    _react2.default.createElement(_richList2.default, { richList: filteredResult, currencyCode: selectedCurrencyCode })
                )
            );
        }
    }]);
...
var RichListTitle = function RichListTitle(_ref) {
    ...
    var pageTitleH1 = titleData.pageTitleH1,
        pageTitleH2 = titleData.pageTitleH2,
        referenceLink = titleData.referenceLink,
...
var RichListFilters = function (_Component) {
    _inherits(RichListFilters, _Component);

    function RichListFilters() {
        _classCallCheck(this, RichListFilters);

        var _this = _possibleConstructorReturn(this, (RichListFilters.__proto__ || Object.getPrototypeOf(RichListFilters)).call(this));

        _this.loadFilterOptionsData = function (newOptionsData) {
            var countryList = newOptionsData.countryList,
                usDollarValue = newOptionsData.usDollarValue,
                euroValue = newOptionsData.euroValue,
                australianDollarValue = newOptionsData.australianDollarValue;

            var countryOptions = [{
                val: 'all',
                text: 'Show All'
            }].concat(countryList.map(function (c) {
                return {
                    val: c,
                    text: c
                };
        ...
        _this.onSelectionChanged = function (name) {
            return function (value) {
                var onFilterChanged = _this.props.onFilterChanged;
    ...
    _createClass(RichListFilters, [{
        key: 'componentWillReceiveProps',
        value: function componentWillReceiveProps(nextProps) {
            var oldOptionsData = this.props.filterOptionsData;
            var newOptionsData = nextProps.filterOptionsData;
        ...
        value: function render() {
            var _state = this.state,
                optionsLoaded = _state.optionsLoaded,
                countryOptions = _state.countryOptions,
                currencyOptions = _state.currencyOptions,
                orderByOptions = _state.orderByOptions;
            var _props = this.props,
                selectedCountry = _props.selectedCountry,
                selectedCurrency = _props.selectedCurrency,
                searchText = _props.searchText,
                selectedOrderBy = _props.selectedOrderBy;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_common.FilterItem, { labelText: 'Birthplace',
                        className: 'filter-item',
                        selectedValue: selectedCountry,
                        options: countryOptions,
                        onSelectionChanged: this.onSelectionChanged('selectedCountry') }),
                    _react2.default.createElement(_common.FilterItem, { labelText: 'Currency Converter',
                        className: 'filter-item',
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'filter-row' },
                    _react2.default.createElement(_common.FilterItem, { type: 'text', labelText: 'Search:', className: 'filter-item',
                        value: searchText,
                        onValueChanged: this.onSearchTextChanged }),
                    _react2.default.createElement(_common.FilterItem, { labelText: 'Order By:',
                        className: 'filter-item',
    ...
    return RichListFilters;
}(_react.Component);

exports.default = RichListFilters;
...
function callApi(endpoint, options) {
    ...
    return fetch(fullUrl, _extends({}, defaultOptions, fetchOptions)).then(function (res) {
        if (res.status >= 400) {
...
function ParseResponse(response) {
    var richList = response.celebrityList,
        pageData = _objectWithoutProperties(response, ['celebrityList']);

    var countryList = _lodash2.default.uniq(richList.map(function (r) {
        return r.country;
    })); // build country list on the fly;

    var pageTitleH1 = pageData.pageTitleH1,
        pageTitleH2 = pageData.pageTitleH2,
        description = pageData.description,
        referenceLink = pageData.referenceLink,
        filterOptionsData = _objectWithoutProperties(pageData, ['pageTitleH1', 'pageTitleH2', 'description', 'referenceLink']);
    ...
    return {
        ...
        filterOptionsData: _extends({}, filterOptionsData, { countryList: countryList }),
        richList: richList
    };
}
...
var toCurrency = exports.toCurrency = function toCurrency(value, currency) {
    if (value === null) {
        return 'N/A';
    }
    var currencyChar = '';
...
var supportedFilterTypes = ['select', 'text'];
var FilterItem = function FilterItem(props) {
    var _props$type = props.type,
        type = _props$type === undefined ? 'select' : _props$type,
    ...
    var onSelectionChanged = function onSelectionChanged(e) {
        ...
        _react2.default.createElement(
            ...
            type === 'select' ? _react2.default.createElement(
                ...
                options.map(function (o) {
                    return _react2.default.createElement(
                        'option',
                        { key: 'option_' + o.val, value: o.val },
                        o.text
                    );
                })
            ) : _react2.default.createElement('input', { value: value, onChange: onValueChanged })
        )
    );
};
...
var RichList = function RichList(_ref) {
    var richList = _ref.richList,
    ...
    return _react2.default.createElement(
        'div',
        { className: 'data-list' },
        richList.map(function (r, index) {
            return _react2.default.createElement(
                'div',
                { className: 'data-item', key: 'item_' + index },
                _react2.default.createElement(
                    'div',
                    { className: 'rank' },
                    ' ',
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        'Net Worth: ',
                        (0, _common.toCurrency)(r.netWorth, currencyCode)
                    )
                ),
                _react2.default.createElement(
                    'div',
